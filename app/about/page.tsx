...
function About() {
  return (
    <>
      ...
      <div className="localBoxShadow px-12 py-4 mt-20">
        <h1 className={"text-center text-5xl md:text-8xl font-bold mt-28 sm:mt-36" + " " + styles.commission}>Thupek leh Thutiam Ropui tak chu 🗺</h1>
